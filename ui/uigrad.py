...
with gr.Blocks() as demo:
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("Analyze Endpoint"):
            ...
            image_input_analyze = gr.Image(type="pil", label="Upload Image")
        ...
        with gr.TabItem("Analyze & Get YOLO Endpoint"):
            ...
            image_input_yolo = gr.Image(type="pil", label="Upload Image")
        ...
        with gr.TabItem("Generate Endpoint"):
            ...
            with gr.Row():
                image_input_generate = gr.Image(type="pil", label="Upload Image")
                prompt_input_generate = gr.Textbox(lines=2, placeholder="Enter prompt", label="Prompt")
